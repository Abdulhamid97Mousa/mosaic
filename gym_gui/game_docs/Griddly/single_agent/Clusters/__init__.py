"""
Clusters environment documentation for MOSAIC.
"""

GRIDDLY_CLUSTERS_HTML = """
<h2>Clusters</h2>

<p>Cluster colored objects by pushing them against static colored blocks. Match all objects with their colors.</p>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr>
        <td style="padding: 8px; border: 1px solid #ddd;">Clusters</td>
        <td style="padding: 8px; border: 1px solid #ddd;"><code>GDY-Clusters-v0</code></td>
    </tr>
</table>
...
<h3>Levels</h3>
<p>5 levels with grid sizes from 6×6 to 10×10.</p>
