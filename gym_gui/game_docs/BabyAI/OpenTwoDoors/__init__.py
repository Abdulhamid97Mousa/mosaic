...
<h3>Description</h3>
<p>Open two doors in sequence. Doors face opposite directions, so agent cannot see if second door is open. Requires memory-based or recurrent policies.</p>

<h3>Mission</h3>
<p><em>"open the {{color}} door, then open the {{color}} door"</em></p>
...
<table style="border-collapse: collapse; width: 100%; margin: 10px 0;">
  ...
  <tr>
    <td style="border: 1px solid #ddd; padding: 8px;">Success (doors opened)</td>
...
<h3>References</h3>
<ul>
<li><strong>Official Documentation:</strong> <a href="https://minigrid.farama.org/environments/babyai/OpenTwoDoors/">BabyAI OpenTwoDoors</a></li>
