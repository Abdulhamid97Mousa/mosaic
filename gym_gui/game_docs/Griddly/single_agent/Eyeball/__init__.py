"""
Eyeball environment documentation for MOSAIC.
"""

GRIDDLY_EYEBALL_HTML = """
<h2>Eyeball</h2>

<p>Port of MiniGrid 4 Rooms. A giant eye looking for eyedrops.</p>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr>
        <td style="padding: 8px; border: 1px solid #ddd;">Eyeball</td>
        <td style="padding: 8px; border: 1px solid #ddd;"><code>GDY-Eyeball-v0</code></td>
    </tr>
</table>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr><td style='padding: 8px; border: 1px solid #ddd;'>Find eyedrops</td><td style='padding: 8px; border: 1px solid #ddd;'>+1 (episode ends)</td></tr>
