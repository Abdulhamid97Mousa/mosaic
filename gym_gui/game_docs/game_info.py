...
from gym_gui.game_docs.BabaIsAI import (
...
# BabaIsAI mappings (rule manipulation puzzle benchmark)
GAME_INFO[GameId.BABAISAI_DEFAULT] = BABAISAI_OVERVIEW_HTML

# gym-multigrid mappings (multi-agent grid environments)
GAME_INFO[GameId.MULTIGRID_SOCCER] = MULTIGRID_SOCCER_HTML
GAME_INFO[GameId.MULTIGRID_COLLECT] = MULTIGRID_COLLECT_HTML

# Melting Pot mappings (multi-agent social scenarios)
GAME_INFO[GameId.MELTINGPOT_COLLABORATIVE_COOKING] = MELTINGPOT_COLLABORATIVE_COOKING_HTML
GAME_INFO[GameId.MELTINGPOT_CLEAN_UP] = MELTINGPOT_CLEAN_UP_HTML
GAME_INFO[GameId.MELTINGPOT_COMMONS_HARVEST] = MELTINGPOT_COMMONS_HARVEST_HTML
GAME_INFO[GameId.MELTINGPOT_TERRITORY] = MELTINGPOT_TERRITORY_HTML
GAME_INFO[GameId.MELTINGPOT_KING_OF_THE_HILL] = MELTINGPOT_KING_OF_THE_HILL_HTML
GAME_INFO[GameId.MELTINGPOT_PRISONERS_DILEMMA] = MELTINGPOT_PRISONERS_DILEMMA_HTML
GAME_INFO[GameId.MELTINGPOT_STAG_HUNT] = MELTINGPOT_STAG_HUNT_HTML
GAME_INFO[GameId.MELTINGPOT_ALLELOPATHIC_HARVEST] = MELTINGPOT_ALLELOPATHIC_HARVEST_HTML
