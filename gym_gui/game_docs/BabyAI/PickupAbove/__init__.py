...
def get_pickup_above_html(env_id: str = "BabyAI-PickupAbove-v0") -> str:
    ...
    return (
        f"<h2>{env_id}</h2>"
        "<p>Pick up an object in the room above. Requires compass navigation "
        "and directional awareness to locate the target.</p>"
        "<h4>Mission</h4>"
        ...
        "<p>See docs: <a href=\"https://minigrid.farama.org/environments/babyai/PickupAbove/\">BabyAI PickupAbove</a></p>"
    )
