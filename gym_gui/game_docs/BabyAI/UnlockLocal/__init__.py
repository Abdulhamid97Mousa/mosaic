"""Documentation for BabyAI UnlockLocal environment."""
from __future__ import annotations


def get_unlock_local_html(env_id: str = "BabyAI-UnlockLocal-v0") -> str:
    """Generate UnlockLocal HTML documentation."""
    return f"""
<h2>{env_id}</h2>
...
<h3>Description</h3>
<p>Retrieve a key and unlock a door within the current room. Tests basic key-door mechanics.</p>
...
<ul>
<li><strong>BabyAI-UnlockLocal-v0</strong></li>
<li><strong>BabyAI-UnlockLocalDist-v0</strong>: With distractors</li>
</ul>
...
<table style="border-collapse: collapse; width: 100%; margin: 10px 0;">
  ...
  <tr>
    <td style="border: 1px solid #ddd; padding: 8px;">Success (door opened)</td>
...
<h3>References</h3>
<ul>
<li><strong>Official Documentation:</strong> <a href="https://minigrid.farama.org/environments/babyai/UnlockLocal/">BabyAI UnlockLocal</a></li>
...
__all__ = ["BABYAI_UNLOCK_LOCAL_HTML", "get_unlock_local_html"]
