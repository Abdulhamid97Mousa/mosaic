...
from barlog_worker.config import BarlogWorkerConfig, load_worker_config
from barlog_worker.runtime import BarlogWorkerRuntime, InteractiveRuntime
...
def main(*args, **kwargs):
    ...
    from barlog_worker.cli import main as _main
