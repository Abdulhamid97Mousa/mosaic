"""
Partially Observable Clusters environment documentation for MOSAIC.
"""

GRIDDLY_PO_CLUSTERS_HTML = """
<h2>Partially Observable Clusters</h2>

<p>Cluster colored objects by pushing them against static colored blocks with limited visibility.</p>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr>
        <td style="padding: 8px; border: 1px solid #ddd;">Partially Observable Clusters</td>
        <td style="padding: 8px; border: 1px solid #ddd;"><code>GDY-Partially-Observable-Clusters-v0</code></td>
    </tr>
</table>
...
<h3>Levels</h3>
<p>5 levels with grid sizes from 6×6 to 10×10. Partial observability window.</p>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr><td style='padding: 8px; border: 1px solid #ddd;'>All clustered</td><td style='padding: 8px; border: 1px solid #ddd;'>+1 (episode ends)</td></tr>
    <tr><td style='padding: 8px; border: 1px solid #ddd;'>Object clustered</td><td style='padding: 8px; border: 1px solid #ddd;'>+0.1</td></tr>
...
__all__ = ["GRIDDLY_PO_CLUSTERS_HTML"]
