...
<p>Navigate a single room to reach a red ball. No distractors present — the simplest GoTo variant for basic navigation learning.</p>
...
<h4>References</h4>
<ul>
    <li><a href="https://minigrid.farama.org/environments/babyai/GoToRedBallNoDists/" target="_blank">Official Documentation</a></li>
