"""
Partially Observable Sokoban - 2 environment documentation for MOSAIC.
"""

GRIDDLY_PO_SOKOBAN_2_HTML = """
<h2>Partially Observable Sokoban - 2</h2>

<p>Push boxes onto marked spaces with limited visibility. Partial observability variant of Sokoban - 2.</p>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr>
        <td style="padding: 8px; border: 1px solid #ddd;">Partially Observable Sokoban - 2</td>
        <td style="padding: 8px; border: 1px solid #ddd;"><code>GDY-Partially-Observable-Sokoban-2-v0</code></td>
    </tr>
</table>
...
<h3>Levels</h3>
<p>6 levels with grid sizes from 7×7 to 11×11. Partial observability window.</p>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr><td style='padding: 8px; border: 1px solid #ddd;'>All boxes placed</td><td style='padding: 8px; border: 1px solid #ddd;'>+1 (episode ends)</td></tr>
    <tr><td style='padding: 8px; border: 1px solid #ddd;'>Box into space</td><td style='padding: 8px; border: 1px solid #ddd;'>+0.1</td></tr>
...
__all__ = ["GRIDDLY_PO_SOKOBAN_2_HTML"]
