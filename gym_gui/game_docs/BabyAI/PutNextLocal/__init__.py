...
<h3>Description</h3>
<p>Place one object adjacent to another in a single room. No doors or distractors. Foundational task for object manipulation.</p>
...
<table style="border-collapse: collapse; width: 100%; margin: 10px 0;">
  ...
  <tr>
    ...
    <td style="border: 1px solid #ddd; padding: 8px;">Drop object next to target</td>
  </tr>
  <tr>
...
<table style="border-collapse: collapse; width: 100%; margin: 10px 0;">
  ...
  <tr>
    <td style="border: 1px solid #ddd; padding: 8px;">Success (object placed correctly)</td>
...
<h3>References</h3>
<ul>
<li><strong>Official Documentation:</strong> <a href="https://minigrid.farama.org/environments/babyai/PutNextLocal/">BabyAI PutNextLocal</a></li>
