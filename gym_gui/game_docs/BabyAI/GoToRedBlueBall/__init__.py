...
<p>Navigate to either a red or blue ball. Exactly one red or blue ball exists, with distractors guaranteed not to be red or blue balls. No language comprehension required.</p>
...
<table style="width:100%; border-collapse: collapse; margin: 10px 0;">
    ...
    <tr><td style="border: 1px solid #ddd; padding: 8px;">Termination</td><td style="border: 1px solid #ddd; padding: 8px;">Agent reaches the target ball</td></tr>
...
<h4>References</h4>
<ul>
    <li><a href="https://minigrid.farama.org/environments/babyai/GoToRedBlueBall/" target="_blank">Official Documentation</a></li>
