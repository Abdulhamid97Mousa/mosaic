"""
Push Mania environment documentation for MOSAIC.
"""

GRIDDLY_PUSH_MANIA_HTML = """
<h2>Push Mania</h2>

<p>Ported from Stratega. Push all opponent's pieces into holes. 2-player competitive game.</p>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr>
        <td style="padding: 8px; border: 1px solid #ddd;">Push Mania</td>
        <td style="padding: 8px; border: 1px solid #ddd;"><code>GDY-Push-Mania-v0</code></td>
    </tr>
</table>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr><td style='padding: 8px; border: 1px solid #ddd;'>Push opponent piece into hole</td><td style='padding: 8px; border: 1px solid #ddd;'>+1</td></tr>
    <tr><td style='padding: 8px; border: 1px solid #ddd;'>All opponent pieces eliminated</td><td style='padding: 8px; border: 1px solid #ddd;'>+10 (episode ends)</td></tr>
    <tr><td style='padding: 8px; border: 1px solid #ddd;'>Your piece pushed into hole</td><td style='padding: 8px; border: 1px solid #ddd;'>-1</td></tr>
</table>
...
__all__ = ["GRIDDLY_PUSH_MANIA_HTML"]
