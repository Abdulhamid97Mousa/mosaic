...
class CliffWalkingAdapter:
    ...
    is_slippery: bool = False  # CliffWalking default is deterministic (not slippery)
    ...
    def __post_init__(self) -> None:
        # If game_config is provided, extract is_slippery from it
        if self.game_config is not None:
            # game_config is a CliffWalkingConfig object from gym_ui
    ...
    def _obs_dict(self, state: int, info: Dict[str, Any] | None = None) -> Dict[str, Any]:
        ...
        result = {
            ...
            "grid_size": {"height": self._nrow, "width": self._ncol},  # CliffWalking is 4x12
        }
