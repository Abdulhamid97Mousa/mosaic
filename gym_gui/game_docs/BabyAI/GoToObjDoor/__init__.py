"""Documentation for BabyAI GoToObjDoor environment."""
from __future__ import annotations


def get_goto_objdoor_html(env_id: str = "BabyAI-GoToObjDoor-v0") -> str:
    """Generate GoToObjDoor HTML documentation."""
    return f"""
<h2>{env_id}</h2>
...
<p>Navigate to a specified object or door in the current room. Target defined by both color and type. Combines object recognition and spatial navigation.</p>

<h4>Mission</h4>
<p><em>"go to the {{color}} {{type}}"</em> — colors: red, green, blue, purple, yellow, grey; types: ball, box, key, door</p>

<h4>Registered Variants</h4>
<ul>
<li><strong>BabyAI-GoToObjDoor-v0</strong></li>
</ul>
...
<table style="width:100%; border-collapse: collapse; margin: 10px 0;">
    ...
    <tr><td style="border: 1px solid #ddd; padding: 8px;">Termination</td><td style="border: 1px solid #ddd; padding: 8px;">Agent reaches the target</td></tr>
...
<h4>References</h4>
<ul>
    <li><a href="https://minigrid.farama.org/environments/babyai/GoToObjDoor/" target="_blank">Official Documentation</a></li>
...
__all__ = ["BABYAI_GOTO_OBJDOOR_HTML", "get_goto_objdoor_html"]
