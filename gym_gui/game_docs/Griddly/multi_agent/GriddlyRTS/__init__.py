"""
GriddlyRTS environment documentation for MOSAIC.
"""

GRIDDLY_RTS_HTML = """
<h2>GriddlyRTS</h2>

<p>RTS-style gameplay with resource gathering, unit production, and base building. 2 players compete to destroy opponent's base.</p>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr>
        <td style="padding: 8px; border: 1px solid #ddd;">GriddlyRTS</td>
        <td style="padding: 8px; border: 1px solid #ddd;"><code>GDY-GriddlyRTS-v0</code></td>
    </tr>
</table>
...
<h3>Levels</h3>
<p>4 levels with grid sizes up to 57×58. Supports isometric rendering.</p>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr><td style='padding: 8px; border: 1px solid #ddd;'>Destroy enemy base</td><td style='padding: 8px; border: 1px solid #ddd;'>+1 (episode ends)</td></tr>
    <tr><td style='padding: 8px; border: 1px solid #ddd;'>Your base destroyed</td><td style='padding: 8px; border: 1px solid #ddd;'>-1 (episode ends)</td></tr>
