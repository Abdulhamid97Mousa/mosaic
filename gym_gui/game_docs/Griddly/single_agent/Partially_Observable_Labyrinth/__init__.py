"""
Partially Observable Labyrinth environment documentation for MOSAIC.
"""

GRIDDLY_PO_LABYRINTH_HTML = """
<h2>Partially Observable Labyrinth</h2>

<p>Navigate through a maze to reach the exit with limited visibility. Avoid spike traps.</p>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr>
        <td style="padding: 8px; border: 1px solid #ddd;">Partially Observable Labyrinth</td>
        <td style="padding: 8px; border: 1px solid #ddd;"><code>GDY-Partially-Observable-Labyrinth-v0</code></td>
    </tr>
</table>
...
<h3>Levels</h3>
<p>5 levels with grid sizes from 9×9 to 15×15. Partial observability window.</p>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr><td style='padding: 8px; border: 1px solid #ddd;'>Reach exit</td><td style='padding: 8px; border: 1px solid #ddd;'>+1 (episode ends)</td></tr>
    <tr><td style='padding: 8px; border: 1px solid #ddd;'>Hit spike</td><td style='padding: 8px; border: 1px solid #ddd;'>-1 (episode ends)</td></tr>
...
__all__ = ["GRIDDLY_PO_LABYRINTH_HTML"]
