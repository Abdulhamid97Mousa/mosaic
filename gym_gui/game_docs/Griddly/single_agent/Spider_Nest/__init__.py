"""
Spider Nest environment documentation for MOSAIC.
"""

GRIDDLY_SPIDER_NEST_HTML = """
<h2>Spider Nest</h2>

<p>Port of MiniGrid Dynamic Obstacles. A gnome avoiding spiders to reach a gem in a large nest.</p>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr>
        <td style="padding: 8px; border: 1px solid #ddd;">Spider Nest</td>
        <td style="padding: 8px; border: 1px solid #ddd;"><code>GDY-Spider-Nest-v0</code></td>
    </tr>
</table>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr><td style='padding: 8px; border: 1px solid #ddd;'>Reach gem</td><td style='padding: 8px; border: 1px solid #ddd;'>+1 (episode ends)</td></tr>
...
__all__ = ["GRIDDLY_SPIDER_NEST_HTML"]
