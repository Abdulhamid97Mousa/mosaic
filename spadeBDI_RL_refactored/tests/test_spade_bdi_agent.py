...
def test_agent_lazy_loading():
    ...
    from spadeBDI_RL_refactored.core import RunConfig, HeadlessTrainer
    
    assert RunConfig is not None
    assert HeadlessTrainer is not None
    
    # Now explicitly load BDI components
    from spadeBDI_RL_refactored.core import (
        AgentHandle,
        DEFAULT_JID,
        DEFAULT_PASSWORD,
        create_agent,
...
def test_agent_creation(check_ejabberd):
    ...
    from spadeBDI_RL_refactored.core import create_agent
...
def test_agent_lifecycle(check_ejabberd):
    ...
    from spadeBDI_RL_refactored.core import create_and_start_agent
...
def test_docker_compose_path():
    ...
    from spadeBDI_RL_refactored.core import docker_compose_path
...
def test_asl_path_resolution():
    ...
    from spadeBDI_RL_refactored.core import resolve_asl
...
def test_agent_with_custom_asl(check_ejabberd):
    ...
    from spadeBDI_RL_refactored.core import create_agent, resolve_asl
