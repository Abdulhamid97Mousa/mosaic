...
<h3>Description</h3>
<p>Like Synth, but with location-based language (in front, behind, left, right). No implicit unlocking. Tests spatial reasoning with natural language.</p>
...
<h3>References</h3>
<ul>
<li><strong>Official Documentation:</strong> <a href="https://minigrid.farama.org/environments/babyai/SynthLoc/">BabyAI SynthLoc</a></li>
