...
<h3>Description</h3>
<p>Pick up an object that may be in another room. Requires navigation and object interaction across multiple room configurations.</p>

<h3>Mission</h3>
<p><em>"pick up a {{color}} {{type}}"</em></p>
...
<h3>References</h3>
<ul>
<li><strong>Official Documentation:</strong> <a href="https://minigrid.farama.org/environments/babyai/Pickup/">BabyAI Pickup</a></li>
