"""
Zen Puzzle environment documentation for MOSAIC.
"""

GRIDDLY_ZEN_PUZZLE_HTML = """
<h2>Zen Puzzle</h2>

<p>Set all tiles to the same color. Cannot move over a tile more than once.</p>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr>
        <td style="padding: 8px; border: 1px solid #ddd;">Zen Puzzle</td>
        <td style="padding: 8px; border: 1px solid #ddd;"><code>GDY-Zen-Puzzle-v0</code></td>
    </tr>
</table>
...
<h3>Levels</h3>
<p>5 levels with grid sizes from 5×5 to 9×9.</p>
...
__all__ = ["GRIDDLY_ZEN_PUZZLE_HTML"]
