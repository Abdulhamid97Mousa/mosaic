...
<p>Locate and pick up a randomly placed object. Requires systematic exploration due to randomized object placement.</p>
...
<table style="width:100%; border-collapse: collapse; margin: 10px 0;">
    ...
    <tr><td style="border: 1px solid #ddd; padding: 8px;">Termination</td><td style="border: 1px solid #ddd; padding: 8px;">Agent picks up the object</td></tr>
...
<h4>References</h4>
<ul>
    <li><a href="https://minigrid.farama.org/environments/babyai/FindObjS5/" target="_blank">Official Documentation</a></li>
