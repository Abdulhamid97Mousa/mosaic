...
<h3>Description</h3>
<p>Locate and open a red door in the current room. Door is always unlocked. Deliberately simplified debugging environment.</p>
...
<table style="border-collapse: collapse; width: 100%; margin: 10px 0;">
  ...
  <tr>
    ...
    <td style="border: 1px solid #ddd; padding: 8px;">Unused</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td style="border: 1px solid #ddd; padding: 8px;">Open door</td>
  </tr>
  <tr>
...
<table style="border-collapse: collapse; width: 100%; margin: 10px 0;">
  ...
  <tr>
    <td style="border: 1px solid #ddd; padding: 8px;">Success (red door opened)</td>
...
<h3>References</h3>
<ul>
<li><strong>Official Documentation:</strong> <a href="https://minigrid.farama.org/environments/babyai/OpenRedDoor/">BabyAI OpenRedDoor</a></li>
