"""
Robot Tag 12v12 environment documentation for MOSAIC.
"""

GRIDDLY_ROBOT_TAG_12V12_HTML = """
<h2>Robot Tag 12v12</h2>

<p>Robots start randomly as 'tagged' or not. Robots can tag other robots. Any robot tagged 3 times dies. 24 players (12v12).</p>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr>
        <td style="padding: 8px; border: 1px solid #ddd;">Robot Tag 12v12</td>
        <td style="padding: 8px; border: 1px solid #ddd;"><code>GDY-Robot-Tag-12v12-v0</code></td>
    </tr>
</table>
...
__all__ = ["GRIDDLY_ROBOT_TAG_12V12_HTML"]
