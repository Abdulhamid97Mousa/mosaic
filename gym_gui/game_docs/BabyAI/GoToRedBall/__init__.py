"""Documentation for BabyAI GoToRedBall environment."""
from __future__ import annotations


def get_goto_redball_html(env_id: str = "BabyAI-GoToRedBall-v0") -> str:
    """Generate GoToRedBall HTML documentation."""
    return f"""
<h2>{env_id}</h2>
...
<p>Navigate a single room to reach a red ball. Includes colored distractors that add visual complexity. This level doesn't require language understanding.</p>
...
<ul>
<li><strong>BabyAI-GoToRedBall-v0</strong></li>
</ul>
...
<h4>References</h4>
<ul>
    <li><a href="https://minigrid.farama.org/environments/babyai/GoToRedBall/" target="_blank">Official Documentation</a></li>
...
__all__ = ["BABYAI_GOTO_REDBALL_HTML", "get_goto_redball_html"]
