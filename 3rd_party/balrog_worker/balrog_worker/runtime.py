...
def _setup_api_key_env(config: BarlogWorkerConfig) -> None:
...
class BarlogWorkerRuntime:
    ...
    def _create_env(self) -> Any:
        ...
        Uses our own environment wrapper (balrog_worker.environments)
        which fixes compatibility issues with standard Gymnasium environments.
        """
        from balrog_worker.environments import make_env
        from omegaconf import OmegaConf
