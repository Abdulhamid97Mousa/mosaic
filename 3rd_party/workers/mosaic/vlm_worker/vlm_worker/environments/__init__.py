...
from vlm_worker.environments.env_wrapper import EnvWrapper
...
def generate_multigrid_description(
    ...
    Delegates to vlm_worker.environments.multigrid.observations.
    """
    from vlm_worker.environments.multigrid import observations
...
def get_multigrid_instruction_prompt(
    ...
    Delegates to vlm_worker.environments.multigrid.prompts.
    """
    from vlm_worker.environments.multigrid import prompts
