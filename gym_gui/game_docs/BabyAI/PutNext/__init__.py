...
<h3>Description</h3>
<p>Move object A next to object B (and object C next to D). Very large number of possible instructions. Some variants cannot be solved by BabyAI bot.</p>

<h3>Mission</h3>
<p><em>"put the {{color}} {{type}} next to the {{color}} {{type}}"</em></p>
...
<table style="border-collapse: collapse; width: 100%; margin: 10px 0;">
  ...
  <tr>
    ...
    <td style="border: 1px solid #ddd; padding: 8px;">Drop the object next to target</td>
  </tr>
  <tr>
...
<table style="border-collapse: collapse; width: 100%; margin: 10px 0;">
  ...
  <tr>
    <td style="border: 1px solid #ddd; padding: 8px;">Success (objects positioned correctly)</td>
...
<h3>References</h3>
<ul>
<li><strong>Official Documentation:</strong> <a href="https://minigrid.farama.org/environments/babyai/PutNext/">BabyAI PutNext</a></li>
