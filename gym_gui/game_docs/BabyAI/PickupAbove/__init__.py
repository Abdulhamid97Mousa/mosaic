"""Documentation for BabyAI PickupAbove environment."""
from __future__ import annotations


def get_pickup_above_html(env_id: str = "BabyAI-PickupAbove-v0") -> str:
    """Generate PickupAbove HTML documentation."""
    return f"""
<h2>{env_id}</h2>
...
<h3>Description</h3>
<p>Pick up an object in the room above. Requires compass navigation and directional awareness to locate the target.</p>

<h3>Mission</h3>
<p><em>"go to the {{color}} {{type}}"</em></p>
<p>Colors: red, green, blue, purple, yellow, grey; Types: ball, box, key</p>

<h3>Registered Variants</h3>
<ul>
<li><strong>BabyAI-PickupAbove-v0</strong></li>
</ul>
...
<table style="border-collapse: collapse; width: 100%; margin: 10px 0;">
  ...
  <tr>
    <td style="border: 1px solid #ddd; padding: 8px;">Success (object picked up)</td>
...
<h3>References</h3>
<ul>
<li><strong>Official Documentation:</strong> <a href="https://minigrid.farama.org/environments/babyai/PickupAbove/">BabyAI PickupAbove</a></li>
...
__all__ = ["BABYAI_PICKUP_ABOVE_HTML", "get_pickup_above_html"]
