"""
Sokoban environment documentation for MOSAIC.
"""

GRIDDLY_SOKOBAN_HTML = """
<h2>Sokoban</h2>

<p>Classic box-pushing puzzle. Push all boxes into holes. Boxes cannot be pulled, only pushed.</p>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr>
        <td style="padding: 8px; border: 1px solid #ddd;">Sokoban</td>
        <td style="padding: 8px; border: 1px solid #ddd;"><code>GDY-Sokoban-v0</code></td>
    </tr>
</table>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr><td style='padding: 8px; border: 1px solid #ddd;'>All boxes in holes</td><td style='padding: 8px; border: 1px solid #ddd;'>+1 (episode ends)</td></tr>
    <tr><td style='padding: 8px; border: 1px solid #ddd;'>Box into hole</td><td style='padding: 8px; border: 1px solid #ddd;'>+0.1</td></tr>
