"""
Partially Observable Bait environment documentation for MOSAIC.
"""

GRIDDLY_PO_BAIT_HTML = """
<h2>Partially Observable Bait</h2>

<p>Collect the key and reach the door with limited visibility. Fill holes with blocks to create paths.</p>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr>
        <td style="padding: 8px; border: 1px solid #ddd;">Partially Observable Bait</td>
        <td style="padding: 8px; border: 1px solid #ddd;"><code>GDY-Partially-Observable-Bait-v0</code></td>
    </tr>
</table>
...
<h3>Levels</h3>
<p>5 levels with grid sizes from 7×7 to 10×10. Partial observability window.</p>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr><td style='padding: 8px; border: 1px solid #ddd;'>Reach door with key</td><td style='padding: 8px; border: 1px solid #ddd;'>+1 (episode ends)</td></tr>
    <tr><td style='padding: 8px; border: 1px solid #ddd;'>Collect key</td><td style='padding: 8px; border: 1px solid #ddd;'>+0.5</td></tr>
