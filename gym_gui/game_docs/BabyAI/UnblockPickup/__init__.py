...
<h3>Description</h3>
<p>Retrieve an object from potentially another room while navigating around obstructing agents blocking the path.</p>

<h3>Mission</h3>
<p><em>"pick up a/the {{color}} {{type}}"</em></p>
...
<h3>References</h3>
<ul>
<li><strong>Official Documentation:</strong> <a href="https://minigrid.farama.org/environments/babyai/UnblockPickup/">BabyAI UnblockPickup</a></li>
