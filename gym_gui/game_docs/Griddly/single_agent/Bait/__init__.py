"""
Bait environment documentation for MOSAIC.
"""

GRIDDLY_BAIT_HTML = """
<h2>Bait</h2>

<p>Collect the key and reach the door. Fill holes with blocks to create paths.</p>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr>
        <td style="padding: 8px; border: 1px solid #ddd;">Bait</td>
        <td style="padding: 8px; border: 1px solid #ddd;"><code>GDY-Bait-v0</code></td>
    </tr>
</table>
