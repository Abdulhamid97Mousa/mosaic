...
from vlm_worker.agents.few_shot import FewShotAgent
from vlm_worker.dataset import InContextDataset
from vlm_worker.environments import make_env
from vlm_worker.utils import get_unique_seed

logger = logging.getLogger(__name__)

# Resolve var/evaluator relative to the repository root so outputs never
# pollute the working directory regardless of where the process is launched.
