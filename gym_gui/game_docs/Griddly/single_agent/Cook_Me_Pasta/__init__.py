"""
Cook Me Pasta environment documentation for MOSAIC.
"""

GRIDDLY_COOK_ME_PASTA_HTML = """
<h2>Cook Me Pasta</h2>

<p>Help the chef create the meal. Ingredients must be combined in the correct order.</p>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr>
        <td style="padding: 8px; border: 1px solid #ddd;">Cook Me Pasta</td>
        <td style="padding: 8px; border: 1px solid #ddd;"><code>GDY-Cook-Me-Pasta-v0</code></td>
    </tr>
</table>
...
__all__ = ["GRIDDLY_COOK_ME_PASTA_HTML"]
