...
<p>Unlock a door blocked by a ball, then navigate to another room to pick up a box. Multi-step challenge combining blocking puzzle and object retrieval.</p>
...
<table style="width:100%; border-collapse: collapse; margin: 10px 0;">
    ...
    <tr><td style="border: 1px solid #ddd; padding: 8px;">Termination</td><td style="border: 1px solid #ddd; padding: 8px;">Agent picks up the box</td></tr>
...
<h4>References</h4>
<ul>
    <li><a href="https://minigrid.farama.org/environments/babyai/BlockedUnlockPickup/" target="_blank">Official Documentation</a></li>
