"""
Spiders environment documentation for MOSAIC.
"""

GRIDDLY_SPIDERS_HTML = """
<h2>Spiders</h2>

<p>Port of MiniGrid Dynamic Obstacles. A gnome avoiding spiders to reach a gem.</p>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr>
        <td style="padding: 8px; border: 1px solid #ddd;">Spiders</td>
        <td style="padding: 8px; border: 1px solid #ddd;"><code>GDY-Spiders-v0</code></td>
    </tr>
</table>
...
<h3>Levels</h3>
<p>5 levels with grid sizes from 6×6 to 19×18.</p>
