"""
Zelda environment documentation for MOSAIC.
"""

GRIDDLY_ZELDA_HTML = """
<h2>Zelda</h2>

<p>A port of the GVGAI game 'Zelda'. Navigate dungeons, collect keys to unlock doors, and avoid enemies.</p>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr>
        <td style="padding: 8px; border: 1px solid #ddd;">Zelda</td>
        <td style="padding: 8px; border: 1px solid #ddd;"><code>GDY-Zelda-v0</code></td>
    </tr>
</table>
