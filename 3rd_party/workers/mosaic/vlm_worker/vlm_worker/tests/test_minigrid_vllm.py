...
Run with:
    ...
    pytest 3rd_party/mosaic/vlm_worker/vlm_worker/tests/test_minigrid_vllm.py -v -s
"""
...
class TestMiniGridEnvironment:
    ...
    def test_create_minigrid_env(self):
        ...
        from vlm_worker.environments.minigrid import make_minigrid_env
    ...
    def test_minigrid_action_space(self):
        ...
        from vlm_worker.environments.minigrid import make_minigrid_env
        from vlm_worker.environments.minigrid.clean_lang_wrapper import MINIGRID_ACTION_SPACE
    ...
    def test_minigrid_object_names(self):
        ...
        from vlm_worker.environments.minigrid import MINIGRID_OBJECT_NAMES
...
class TestVLLMIntegration:
    ...
    def test_vllm_minigrid_action(self):
        ...
        from openai import OpenAI
        from vlm_worker.environments.minigrid import get_instruction_prompt
...
class TestFullIntegration:
    ...
    def test_description_shows_goal_not_lava(self):
        ...
        from vlm_worker.environments.minigrid import make_minigrid_env, generate_minigrid_descriptions
