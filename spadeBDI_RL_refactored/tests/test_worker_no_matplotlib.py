...
from spadeBDI_RL_refactored.core import RunConfig, HeadlessTrainer, TelemetryEmitter
from spadeBDI_RL_refactored.adapters.frozenlake import FrozenLakeAdapter
from spadeBDI_RL_refactored.algorithms import QLearningAgent
...
def test_worker_dry_run():
    ...
    config = {
        "run_id": "test_run_001",
        "env_id": "FrozenLake-v2",  # Use v2 which is registered
