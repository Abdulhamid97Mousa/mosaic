"""
Bait With Keys environment documentation for MOSAIC.
"""

GRIDDLY_BAIT_WITH_KEYS_HTML = """
<h2>Bait With Keys</h2>

<p>Collect the key and reach the door. Fill holes with blocks. Key is visible when collected.</p>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr>
        <td style="padding: 8px; border: 1px solid #ddd;">Bait With Keys</td>
        <td style="padding: 8px; border: 1px solid #ddd;"><code>GDY-Bait-With-Keys-v0</code></td>
    </tr>
</table>
...
<h3>Levels</h3>
<p>5 levels with grid sizes from 7×7 to 10×10.</p>
...
__all__ = ["GRIDDLY_BAIT_WITH_KEYS_HTML"]
