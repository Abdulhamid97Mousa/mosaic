"""
Partially Observable Zen Puzzle environment documentation for MOSAIC.
"""

GRIDDLY_PO_ZEN_PUZZLE_HTML = """
<h2>Partially Observable Zen Puzzle</h2>

<p>Set all tiles to the same color with limited visibility. Cannot move over a tile more than once.</p>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr>
        <td style="padding: 8px; border: 1px solid #ddd;">Partially Observable Zen Puzzle</td>
        <td style="padding: 8px; border: 1px solid #ddd;"><code>GDY-Partially-Observable-Zen-Puzzle-v0</code></td>
    </tr>
</table>
...
<h3>Levels</h3>
<p>5 levels with grid sizes from 5×5 to 9×9. Partial observability window.</p>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr><td style='padding: 8px; border: 1px solid #ddd;'>All tiles same color</td><td style='padding: 8px; border: 1px solid #ddd;'>+1 (episode ends)</td></tr>
    <tr><td style='padding: 8px; border: 1px solid #ddd;'>Move over tile twice</td><td style='padding: 8px; border: 1px solid #ddd;'>-1 (episode ends)</td></tr>
...
__all__ = ["GRIDDLY_PO_ZEN_PUZZLE_HTML"]
