...
def get_goto_redball_html(env_id: str = "BabyAI-GoToRedBall-v0") -> str:
    ...
    return (
        f"<h2>{env_id}</h2>"
        "<p>Navigate a single room to reach a red ball. Includes colored distractors that add "
        "visual complexity. This level doesn't require language understanding.</p>"
        "<h4>Mission</h4>"
        ...
        "<p>See docs: <a href=\"https://minigrid.farama.org/environments/babyai/GoToRedBall/\">BabyAI GoToRedBall</a></p>"
    )
