...
<p>Navigate to a target object that may be in a locked room. Requires maze navigation, object pursuit, and imperative unlock reasoning. No unblocking required.</p>

<h4>Mission</h4>
<p><em>"go to a/the {{color}} {{type}}"</em> — colors: red, green, blue, purple, yellow, grey; types: ball, box, key</p>
...
<table style="width:100%; border-collapse: collapse; margin: 10px 0;">
    ...
    <tr><td style="border: 1px solid #ddd; padding: 8px;">E or Enter</td><td style="border: 1px solid #ddd; padding: 8px;">TOGGLE</td><td style="border: 1px solid #ddd; padding: 8px;"><strong>5</strong></td><td style="border: 1px solid #ddd; padding: 8px;">Open/unlock doors</td></tr>
...
<table style="width:100%; border-collapse: collapse; margin: 10px 0;">
    ...
    <tr><td style="border: 1px solid #ddd; padding: 8px;">Termination</td><td style="border: 1px solid #ddd; padding: 8px;">Agent reaches the target object</td></tr>
...
<h4>References</h4>
<ul>
    <li><a href="https://minigrid.farama.org/environments/babyai/GoToImpUnlock/" target="_blank">Official Documentation</a></li>
