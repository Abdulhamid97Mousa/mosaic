...
<h3>Description</h3>
<p>Unlock door A which requires unlocking door B first. Sequential unlocking puzzle with dependency chain. Tests hierarchical planning and multi-step reasoning.</p>
...
<table style="border-collapse: collapse; width: 100%; margin: 10px 0;">
  ...
  <tr>
    ...
    <td style="border: 1px solid #ddd; padding: 8px;">Pick up keys or ball</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td style="border: 1px solid #ddd; padding: 8px;">Unlock and open doors</td>
  </tr>
  <tr>
...
<table style="border-collapse: collapse; width: 100%; margin: 10px 0;">
  ...
  <tr>
    <td style="border: 1px solid #ddd; padding: 8px;">Success (ball picked up)</td>
  ...
  <tr>
    ...
    <td style="border: 1px solid #ddd; padding: 8px;">On ball pickup or max_steps reached</td>
  </tr>
</table>

<h3>References</h3>
<ul>
<li><strong>Official Documentation:</strong> <a href="https://minigrid.farama.org/environments/babyai/UnlockToUnlock/">BabyAI UnlockToUnlock</a></li>
