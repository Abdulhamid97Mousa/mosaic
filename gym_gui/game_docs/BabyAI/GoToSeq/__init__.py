...
<p>Sequencing of go-to-object commands. Complete multiple navigation objectives in sequence. No locked rooms or blocking obstacles. Tests memory and planning.</p>
...
<table style="width:100%; border-collapse: collapse; margin: 10px 0;">
    ...
    <tr><td style="border: 1px solid #ddd; padding: 8px;">Termination</td><td style="border: 1px solid #ddd; padding: 8px;">Agent completes all sequential objectives</td></tr>
...
<h4>References</h4>
<ul>
    <li><a href="https://minigrid.farama.org/environments/babyai/GoToSeq/" target="_blank">Official Documentation</a></li>
