"""Documentation for SMACv2: 10gen_zerg (Procedural Zerg compositions)."""
...
def get_smacv2_zerg_html() -> str:
    """Generate HTML documentation for the 10gen_zerg map."""
    return f"""
<h2>SMACv2: 10gen_zerg</h2>
...
Team compositions vary every episode with random Zerg units, forcing agents
...
<table style="width:100%; border-collapse: collapse; margin: 10px 0;">
    ...
    <tr><td style="border: 1px solid #ddd; padding: 8px;">Map Name</td><td style="border: 1px solid #ddd; padding: 8px;"><code>10gen_zerg</code></td></tr>
    <tr><td style="border: 1px solid #ddd; padding: 8px;">Race</td><td style="border: 1px solid #ddd; padding: 8px;">Zerg</td></tr>
    <tr><td style="border: 1px solid #ddd; padding: 8px;">Unit Pool</td><td style="border: 1px solid #ddd; padding: 8px;">Zerglings, Hydralisks, Banelings</td></tr>
...
<p><b>Notes:</b> Fast melee swarm with ranged support.
Banelings are suicidal -- agents must learn when to detonate for maximum splash damage.</p>
...
SMACV2_ZERG_HTML = get_smacv2_zerg_html()

__all__ = ["SMACV2_ZERG_HTML", "get_smacv2_zerg_html"]
