"""Documentation for SMACv2: 10gen_protoss (Procedural Protoss compositions)."""
...
def get_smacv2_protoss_html() -> str:
    """Generate HTML documentation for the 10gen_protoss map."""
    return f"""
<h2>SMACv2: 10gen_protoss</h2>
...
Team compositions vary every episode with random Protoss units, forcing agents
...
<table style="width:100%; border-collapse: collapse; margin: 10px 0;">
    ...
    <tr><td style="border: 1px solid #ddd; padding: 8px;">Map Name</td><td style="border: 1px solid #ddd; padding: 8px;"><code>10gen_protoss</code></td></tr>
...
<p><b>Notes:</b> Mixed ranged/melee with high-damage Colossi.
Stalkers must kite while Zealots tank; Colossi provide AoE damage.</p>
...
SMACV2_PROTOSS_HTML = get_smacv2_protoss_html()

__all__ = ["SMACV2_PROTOSS_HTML", "get_smacv2_protoss_html"]
