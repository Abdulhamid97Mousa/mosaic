"""
Curriculum Learning Wrappers for XuanCe using Syllabus-RL.

This module provides algorithm-agnostic curriculum wrappers that work with
any XuanCe algorithm (PPO, DQN, SAC, etc.) by operating at the environment level.
