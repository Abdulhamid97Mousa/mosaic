"""
Heal Or Die environment documentation for MOSAIC.
"""

GRIDDLY_HEAL_OR_DIE_HTML = """
<h2>Heal Or Die</h2>

<p>Ported from Stratega. Units that heal and units that perform close combat. Unit health decreases each turn. 2-player competitive game.</p>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr>
        <td style="padding: 8px; border: 1px solid #ddd;">Heal Or Die</td>
        <td style="padding: 8px; border: 1px solid #ddd;"><code>GDY-Heal-Or-Die-v0</code></td>
    </tr>
</table>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr><td style='padding: 8px; border: 1px solid #ddd;'>Kill all opponent units</td><td style='padding: 8px; border: 1px solid #ddd;'>+1 (episode ends)</td></tr>
    <tr><td style='padding: 8px; border: 1px solid #ddd;'>All your units die</td><td style='padding: 8px; border: 1px solid #ddd;'>-1 (episode ends)</td></tr>
...
__all__ = ["GRIDDLY_HEAL_OR_DIE_HTML"]
