"""
Partially Observable Zelda environment documentation for MOSAIC.
"""

GRIDDLY_PO_ZELDA_HTML = """
<h2>Partially Observable Zelda</h2>

<p>Port of GVGAI Zelda with limited visibility. Pick up keys to reach doors and avoid enemies.</p>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr>
        <td style="padding: 8px; border: 1px solid #ddd;">Partially Observable Zelda</td>
        <td style="padding: 8px; border: 1px solid #ddd;"><code>GDY-Partially-Observable-Zelda-v0</code></td>
    </tr>
</table>
...
<h3>Levels</h3>
<p>3 levels with grid sizes from 8×8 to 13×10. Partial observability window.</p>
