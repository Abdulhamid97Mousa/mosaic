...
<p>Superset of all BabyAI levels. Highest difficulty in the BabyAI curriculum. Combines all competencies into complex multi-step tasks.</p>
...
<h4>References</h4>
<ul>
    <li><a href="https://minigrid.farama.org/environments/babyai/BossLevel/" target="_blank">Official Documentation</a></li>
