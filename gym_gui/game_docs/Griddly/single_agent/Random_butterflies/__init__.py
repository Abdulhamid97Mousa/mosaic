"""
Random Butterflies environment documentation for MOSAIC.
"""

GRIDDLY_RANDOM_BUTTERFLIES_HTML = """
<h2>Random Butterflies</h2>

<p>Catch butterflies while avoiding spiders. Butterflies and spiders spawn randomly. Partial observability.</p>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr>
        <td style="padding: 8px; border: 1px solid #ddd;">Random Butterflies</td>
        <td style="padding: 8px; border: 1px solid #ddd;"><code>GDY-Random-butterflies-v0</code></td>
    </tr>
</table>
...
<h3>Levels</h3>
<p>1 level with 15×15 grid. Partial observability window.</p>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr><td style='padding: 8px; border: 1px solid #ddd;'>Catch butterfly</td><td style='padding: 8px; border: 1px solid #ddd;'>+1</td></tr>
    <tr><td style='padding: 8px; border: 1px solid #ddd;'>Hit spider</td><td style='padding: 8px; border: 1px solid #ddd;'>-1 (episode ends)</td></tr>
    <tr><td style='padding: 8px; border: 1px solid #ddd;'>No butterflies left</td><td style='padding: 8px; border: 1px solid #ddd;'>Episode ends</td></tr>
</table>
...
__all__ = ["GRIDDLY_RANDOM_BUTTERFLIES_HTML"]
