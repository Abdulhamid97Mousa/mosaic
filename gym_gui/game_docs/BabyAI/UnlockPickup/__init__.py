...
<h3>Description</h3>
<p>Unlock a door and retrieve a box from another room. Combines unlocking mechanics with object retrieval.</p>

<h3>Mission</h3>
<p><em>"pick up the {{color}} box"</em></p>
...
<table style="border-collapse: collapse; width: 100%; margin: 10px 0;">
  ...
  <tr>
    ...
    <td style="border: 1px solid #ddd; padding: 8px;">Pick up key or box</td>
  </tr>
  <tr>
...
<table style="border-collapse: collapse; width: 100%; margin: 10px 0;">
  ...
  <tr>
    <td style="border: 1px solid #ddd; padding: 8px;">Success (box picked up)</td>
  ...
  <tr>
    ...
    <td style="border: 1px solid #ddd; padding: 8px;">On box pickup or max_steps reached</td>
  </tr>
</table>

<h3>References</h3>
<ul>
<li><strong>Official Documentation:</strong> <a href="https://minigrid.farama.org/environments/babyai/UnlockPickup/">BabyAI UnlockPickup</a></li>
