...
<p>Move two objects across the environment. Multi-object manipulation task requiring planning and coordination.</p>
...
<h4>References</h4>
<ul>
    <li><a href="https://minigrid.farama.org/environments/babyai/" target="_blank">Official Documentation</a></li>
