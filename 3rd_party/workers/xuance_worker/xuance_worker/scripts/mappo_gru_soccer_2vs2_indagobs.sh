...
#
# Benefits of action masking (Approach 2):
...
#   - No wrapper needed during inference
#
# Masked actions: [0=noop, 6=toggle, 7=done]
# Active actions: [1=left, 2=right, 3=forward, 4=pickup, 5=drop]
#
