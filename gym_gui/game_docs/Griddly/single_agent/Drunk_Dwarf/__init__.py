"""
Drunk Dwarf environment documentation for MOSAIC.
"""

GRIDDLY_DRUNK_DWARF_HTML = """
<h2>Drunk Dwarf</h2>

<p>Port of MiniGrid environment. A drunk dwarf trying to find keys to get to bed.</p>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr>
        <td style="padding: 8px; border: 1px solid #ddd;">Drunk Dwarf</td>
        <td style="padding: 8px; border: 1px solid #ddd;"><code>GDY-Drunk-Dwarf-v0</code></td>
    </tr>
</table>
...
<h3>Levels</h3>
<p>5 levels with grid sizes from 5×5 to 19×19.</p>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr><td style='padding: 8px; border: 1px solid #ddd;'>Reach bed with key</td><td style='padding: 8px; border: 1px solid #ddd;'>+1 (episode ends)</td></tr>
...
__all__ = ["GRIDDLY_DRUNK_DWARF_HTML"]
