"""
Butterflies and Spiders environment documentation for MOSAIC.
"""

GRIDDLY_BUTTERFLIES_AND_SPIDERS_HTML = """
<h2>Butterflies and Spiders</h2>

<p>Catch butterflies while avoiding spiders. Butterflies spawn from cocoons and are eaten by spiders.</p>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr>
        <td style="padding: 8px; border: 1px solid #ddd;">Butterflies and Spiders</td>
        <td style="padding: 8px; border: 1px solid #ddd;"><code>GDY-Butterflies-and-Spiders-v0</code></td>
    </tr>
</table>
...
__all__ = ["GRIDDLY_BUTTERFLIES_AND_SPIDERS_HTML"]
