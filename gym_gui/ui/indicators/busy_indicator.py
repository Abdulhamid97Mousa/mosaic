...
"""Modal busy indicator dialog utilities centralised for UI components."""
...
class _BusyDialog(QtWidgets.QDialog):
    """Small frameless dialog with an auto-advancing progress bar."""
...
class _BusyDialogHandle:
    """Small handle that lets callers update busy-dialog state without exposing internals."""
...
def modal_busy_indicator(
    ...
    *,
    ...
    """Display a modal progress dialog during blocking operations."""
