...
<p>Comprehensive challenge combining all BabyAI competencies. Union of all task types in a moderately-sized room with lower probability of locked rooms than BossLevel.</p>
...
<table style="width:100%; border-collapse: collapse; margin: 10px 0;">
    ...
    <tr><td style="border: 1px solid #ddd; padding: 8px;">Termination</td><td style="border: 1px solid #ddd; padding: 8px;">Task completed</td></tr>
...
<h4>References</h4>
<ul>
    <li><a href="https://minigrid.farama.org/environments/babyai/MiniBossLevel/" target="_blank">Official Documentation</a></li>
