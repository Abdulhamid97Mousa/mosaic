"""
Labyrinth environment documentation for MOSAIC.
"""

GRIDDLY_LABYRINTH_HTML = """
<h2>Labyrinth</h2>

<p>Navigate through a maze to reach the exit. Avoid spike traps.</p>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr>
        <td style="padding: 8px; border: 1px solid #ddd;">Labyrinth</td>
        <td style="padding: 8px; border: 1px solid #ddd;"><code>GDY-Labyrinth-v0</code></td>
    </tr>
</table>
...
<h3>Levels</h3>
<p>5 levels with grid sizes from 9×9 to 15×15.</p>
...
__all__ = ["GRIDDLY_LABYRINTH_HTML"]
