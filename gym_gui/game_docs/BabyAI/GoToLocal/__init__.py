...
<p>Navigate to a specified object in a single room with distractors. No doors. Difficulty scales with room size and number of distractors (S{{X}}N{{Y}} naming).</p>
...
<h4>References</h4>
<ul>
    <li><a href="https://minigrid.farama.org/environments/babyai/GoToLocal/" target="_blank">Official Documentation</a></li>
