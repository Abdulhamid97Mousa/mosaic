"""Documentation for BabyAI GoToRedBallGrey environment."""
from __future__ import annotations


def get_goto_redball_grey_html(env_id: str = "BabyAI-GoToRedBallGrey-v0") -> str:
    """Generate GoToRedBallGrey HTML documentation."""
    return f"""
<h2>{env_id}</h2>
...
<p>Navigate a single room to reach a red ball. Distractors are present but all grey to reduce perceptual complexity. This level has distractors but doesn't require language understanding.</p>
...
<ul>
<li><strong>BabyAI-GoToRedBallGrey-v0</strong></li>
</ul>
...
<table style="width:100%; border-collapse: collapse; margin: 10px 0;">
    ...
    <tr><td style="border: 1px solid #ddd; padding: 8px;">Termination</td><td style="border: 1px solid #ddd; padding: 8px;">Agent reaches the red ball</td></tr>
...
<h4>References</h4>
<ul>
    <li><a href="https://minigrid.farama.org/environments/babyai/GoToRedBallGrey/" target="_blank">Official Documentation</a></li>
...
__all__ = ["BABYAI_GOTO_REDBALL_GREY_HTML", "get_goto_redball_grey_html"]
