"""
Kill The King environment documentation for MOSAIC.
"""

GRIDDLY_KILL_THE_KING_HTML = """
<h2>Kill The King</h2>

<p>Ported from Stratega. Protect your king while trying to kill opponent's king. 2-player competitive game.</p>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr>
        <td style="padding: 8px; border: 1px solid #ddd;">Kill The King</td>
        <td style="padding: 8px; border: 1px solid #ddd;"><code>GDY-Kill-The-King-v0</code></td>
    </tr>
</table>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr><td style='padding: 8px; border: 1px solid #ddd;'>Kill opponent king</td><td style='padding: 8px; border: 1px solid #ddd;'>+1 (episode ends)</td></tr>
    <tr><td style='padding: 8px; border: 1px solid #ddd;'>Your king killed</td><td style='padding: 8px; border: 1px solid #ddd;'>-1 (episode ends)</td></tr>
...
__all__ = ["GRIDDLY_KILL_THE_KING_HTML"]
