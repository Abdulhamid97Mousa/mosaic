...
def create_llm_client(client_config):
    ...
    def client_factory():
        ...
        if "openai" in client_name_lower or "vllm" in client_name_lower or "nvidia" in client_name_lower or "xai" in client_name_lower or "openrouter" in client_name_lower:
            # OpenRouter, NVIDIA, XAI, and vLLM use OpenAI-compatible API
