"""
Foragers environment documentation for MOSAIC.
"""

GRIDDLY_FORAGERS_HTML = """
<h2>Foragers</h2>

<p>Simple multi-agent game. Agents must collect colored potions scattered across the map. Cooperative or competitive depending on reward structure.</p>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr>
        <td style="padding: 8px; border: 1px solid #ddd;">Foragers</td>
        <td style="padding: 8px; border: 1px solid #ddd;"><code>GDY-Foragers-v0</code></td>
    </tr>
</table>
...
<h3>Levels</h3>
<p>3 levels with grid sizes from 9×10 to 18×20.</p>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr><td style='padding: 8px; border: 1px solid #ddd;'>Collect potion</td><td style='padding: 8px; border: 1px solid #ddd;'>+1</td></tr>
    <tr><td style='padding: 8px; border: 1px solid #ddd;'>All potions collected</td><td style='padding: 8px; border: 1px solid #ddd;'>Episode ends</td></tr>
