"""
Sokoban - 2 environment documentation for MOSAIC.
"""

GRIDDLY_SOKOBAN_2_HTML = """
<h2>Sokoban - 2</h2>

<p>Push boxes onto marked spaces. Once a box is on a space, it cannot be moved. Variant 2 with different layouts.</p>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr>
        <td style="padding: 8px; border: 1px solid #ddd;">Sokoban - 2</td>
        <td style="padding: 8px; border: 1px solid #ddd;"><code>GDY-Sokoban-2-v0</code></td>
    </tr>
</table>
...
<h3>Levels</h3>
<p>6 levels with grid sizes from 7×7 to 11×11.</p>
...
__all__ = ["GRIDDLY_SOKOBAN_2_HTML"]
