...
<p>Navigate to a specific colored door in the current room. Straightforward task with no distractors. Foundational navigation task in BabyAI curriculum.</p>
...
<table style="width:100%; border-collapse: collapse; margin: 10px 0;">
    ...
    <tr><td style="border: 1px solid #ddd; padding: 8px;">Termination</td><td style="border: 1px solid #ddd; padding: 8px;">Agent reaches the door</td></tr>
...
<h4>References</h4>
<ul>
    <li><a href="https://minigrid.farama.org/environments/babyai/GoToDoor/" target="_blank">Official Documentation</a></li>
