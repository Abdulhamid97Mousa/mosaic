"""
Robot Tag 4v4 environment documentation for MOSAIC.
"""

GRIDDLY_ROBOT_TAG_4V4_HTML = """
<h2>Robot Tag 4v4</h2>

<p>Robots start randomly as 'tagged' or not. Robots can tag other robots. Any robot tagged 3 times dies. 8 players (4v4).</p>
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr>
        <td style="padding: 8px; border: 1px solid #ddd;">Robot Tag 4v4</td>
        <td style="padding: 8px; border: 1px solid #ddd;"><code>GDY-Robot-Tag-4v4-v0</code></td>
    </tr>
</table>
...
__all__ = ["GRIDDLY_ROBOT_TAG_4V4_HTML"]
