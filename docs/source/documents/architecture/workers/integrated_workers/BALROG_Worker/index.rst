...
.. figure:: /images/workers/concepts/balrog_diagram.png
   ...
   BALROG evaluation pipeline (`Paglieri et al., 2024 <https://arxiv.org/abs/2411.13543>`_): ``env_wrapper.py``, ``client.py``, ``evaluator.py``, and ``agent.py`` collaborate to drive LLM/VLM agents through game environments.
